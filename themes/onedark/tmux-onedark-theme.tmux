...
onedark_red="#e06c75"
onedark_white="#e0e0e0"
onedark_green="#98c379"
onedark_visual_grey="#3e4452"
onedark_comment_grey="#bdbdbd"
...
set "status-right" "#[fg=$onedark_white,bg=$onedark_black,nounderscore,noitalics]${time_format}  ${date_format} #[fg=$onedark_visual_grey,bg=$onedark_black]#[fg=$onedark_visual_grey,bg=$onedark_visual_grey]#[fg=$onedark_white, bg=$onedark_visual_grey]${status_widgets} #[fg=#64b5f6,bg=$onedark_visual_grey,nobold,nounderscore,noitalics]#[fg=$onedark_black,bg=#64b5f6,bold] $(whoami) #[fg=$onedark_black, bg=#64b5f6]#[fg=$onedark_black,bg=#64b5f6,bold] #h "
set "status-left" "#[fg=$onedark_black,bg=#64b5f6,bold] #S #{prefix_highlight}#[fg=#64b5f6,bg=$onedark_black,nobold,nounderscore,noitalics]"
